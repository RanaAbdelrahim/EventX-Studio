...
import marketingRoutes from './routes/marketing.js'; // Add this line
...
export async function createServer() {
  ...
  // 3) CORS
  // Support comma-separated list via CLIENT_URL or CORS_ORIGINS
  const originsEnv = process.env.CLIENT_URL || process.env.CORS_ORIGINS || 'http://localhost:5173';
  ...
  app.use('/api/marketing', marketingRoutes); // Add this line

  // 7) 404 for API paths (place after routes, before error handler)
